...
SpecBegin(MFWalkthrough)
    ...
    describe(@"MFWalkthroughViewController", ^{
      ...
      __block id <MFWalkthroughDelegate> delegate = mockProtocol(@protocol(MFWalkthroughDelegate));
      __block id <MFWalkthroughDataSource> dataSource = mockProtocol(@protocol(MFWalkthroughDataSource));
      ...
      before(^{
        ...
        walkthroughController = [[MFWalkthroughViewController alloc]
                                                              initWithViewControllers:@[firstViewController, secondViewController, lastViewController]];
      ...
      it(@"should have proper default values", ^{
        expect(walkthroughController.navigationButtonColor).to.equal(navigationController.navigationBar.tintColor);
     ...
     willContinueFromViewController:firstViewController
      ...
      it(@"should react to property change and transition to second view controller", ^{
        ...
        expect(continueButton.buttonStyle).to.equal(kFRDLivelyButtonStyleCaretRight);
